...
async function getProductDetail() {
    ...
    products.forEach(productData => {
        if(productData._id === productId){
            ...
            document.querySelector("#work-name").innerHTML= `${productData.productName} | ${productData.painterName}`;
            ...
            document.querySelector("#painter-link").href= `/painter/?name=${productData.painterName}`;
        }
    })
}
getProductDetail();
...
function addCart(){
    ...
    let price = Number(document.querySelector(".work-price").textContent.replace("원", ""));
    let [productName, painterName] = document.querySelector("#work-name").textContent.split(" | ");
